...
const PlanCard: React.FC<{plan: Plan}> = ({plan}) => (
    <div className={`border rounded-2xl p-8 flex flex-col ${plan.isPopular ? 'border-primary shadow-2xl scale-105' : 'border-gray-300 bg-white'}`}>
        ...
        <button className={`mt-8 w-full py-3 rounded-lg font-bold text-lg ${plan.isPopular ? 'bg-primary text-white hover:bg-primary-hover' : 'bg-primary/10 text-primary hover:bg-primary/20'}`}>
            Contratar Plano
        </button>
    </div>
)
    ...
    <div className="bg-slate-50 text-gray-800">
      <header className="fixed top-0 left-0 right-0 bg-white/80 backdrop-blur-md shadow-sm z-50">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <button onClick={onLogin} className="bg-primary text-white font-bold py-2 px-6 rounded-lg shadow-md hover:bg-primary-hover transition-colors">
            Acessar Painel
          </button>
        </div>
      </header>
      ...
      <main>
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-2xl shadow-md text-center">
                <div className="bg-primary-light text-primary rounded-full p-4 inline-block">{ICONS.whatsapp}</div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-md text-center">
                <div className="bg-primary-light text-primary rounded-full p-4 inline-block">{ICONS.dashboard}</div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-md text-center">
                <div className="bg-primary-light text-primary rounded-full p-4 inline-block">{ICONS.messageCircle}</div>
        ...
        <section id="pricing" className="py-20">
            <div className="container mx-auto px-6">
                <div className="text-center mb-12">
                    <h2 className="text-3xl lg:text-4xl font-bold">Planos transparentes, sem surpresas</h2>
                ...
                <div className="space-y-4">
                    ...
                    <FaqItem question="Posso personalizar as mensagens enviadas pela IA?">
                     ...
                     <FaqItem question="Existe um período de teste gratuito?">
                        Sim! Oferecemos o Plano Grátis que permite que você utilize as funcionalidades essenciais da agenda para sempre, com algumas limitações. É a maneira perfeita de começar e entender como o Interativix-bot pode ajudar seu negócio.
                    </FaqItem>
                </div>
            </div>
        </section>
      ...
      <footer className="bg-gray-800 text-white py-12">
        <div className="container mx-auto px-6 text-center">
            <p>&copy; 2024 Interativix-bot. Todos os direitos reservados.</p>
        </div>
      </footer>
    </div>
  );
